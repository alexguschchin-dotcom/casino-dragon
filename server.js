...
const taskTemplates = [
  ...
  { difficulty: 1, texts: [
    ...
    'Приключение F15: Наш корабль сломался! Отправиться в путишествие до следующего острова на поезде. Купить Money Train 3 за 50 000 дублонов.',
    ...
    'Приключение F21: Вам скучно! Потратьте деньги, сделайте 30 спинов в Dog House Multihold по 2000 дублонов.',
    ...
    'Приключение F25: Рыбалка вместе в енотом! Выбить бонус в Le Fisherman (ставка 2000 дублонов).',
    ...
    'Приключение F37: Вы попали на древний остров! Сделайте 30 спинов по 1000 дублонов в Medusa stone.',
  ...
  { difficulty: 2, texts: [
    ...
    'Вылазка D12: Вам понравилось путешествие в поезде! Покупать бонуски в Money Train 3 за 50 000 дублонов пока не почувствуешь золотые монеты (окуп).',
  ...
  { difficulty: 3, texts: [
    ...
    'Плавание C5: На неизвестном отсрове вы обнаруживаете дом Минотавра, вы потревожили его сон! Пусть он устанет прыгнув в общем 50 раз в бонуске за 60 000.',
  ...
  { difficulty: 4, texts: [
    ...
    'Шторм B10: Задание от Зевса! Поймать x20 в Gates of Olympus.',
    ...
    'Шторм B14: Прогулка с вампирами. Выбить бонус в The Vampires 2 по ставке от 4000 дублонов.',
  ...
  { difficulty: 5, texts: [
    ...
    'Капитанское A9: Путешествие класса люкс! Купить бонус в Money Train 4 за 300 000 дублонов дважды.',
...
const penaltyTemplates = [
  ...
  'Наказание: Спонсируешь Викин стрим на 100к',
